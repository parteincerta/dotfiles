...
homebrew_casks=(
	alt-tab betterdisplay brave-browser bruno "${compass[@]}" dbeaver-community
	docker fork ghostty iina json-viewer kitty mac-mouse-fix "${microsoft[@]}"
	mist numi obs onyx parallels signal spaceid transmission visual-studio-code
	whatsapp zed
)
