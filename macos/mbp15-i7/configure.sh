...
cp "$rootdir/shared_macos/docker.fish" "$XDG_CONFIG_HOME/fish/completions/"
...
if [ -n "$HOMEBREW_PREFIX" ]; then
	...
	export kitty_qat_margin_left="180"
	export kitty_qat_margin_right="180"
	export kitty_window_height="35c"
	export kitty_window_width="140c"
