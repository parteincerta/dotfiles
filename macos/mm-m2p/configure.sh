...
sed -i '' "s|#EXTERNAL_VOLUME|/Volumes/A3|" "$HOME/.bash_profile"
...
sed -i '' "s|#EXTERNAL_VOLUME|/Volumes/A3|" "$XDG_CONFIG_HOME/fish/config.fish"
...
if [ -n "$HOMEBREW_PREFIX" ]; then
	...
	export terminal_window_width="200"
