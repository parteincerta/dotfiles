...
homebrew_casks=(
	...
	"$docker" "$font" foobar2000 fork ghostty iina json-viewer mac-mouse-fix
	melonds mgba-app "${microsoft[@]}" mist numi obs parallels sameboy spaceid
	transmission "$vscode" zed
)
